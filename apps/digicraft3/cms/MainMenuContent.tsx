...
export const mainMenuContent: MenuItem[] = [
	...
	{
		heading: 'Lebenslaufgenerator',
		body: <><div>Trennung von Daten und Ansicht</div></>,
		mediaIcons: [MediaIcon.desktop, MediaIcon.mobilePhone],
		route: routes.resumeGenerator,
		svg: bgSvg.app,
		// dev: true,
	},
	{
		heading: 'Sprüche',
		body: <><div>Der Anfang von allem</div></>,
		mediaIcons: [MediaIcon.desktop, MediaIcon.mobilePhone],
		route: routes.quotes,
		svg: bgSvg.app,
		// dev: true,
