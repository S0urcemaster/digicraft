...
export const svgs: Record<string, Record<string, ReactNode>> = {
	white: {
		king:
		...
		rook:
			<g opacity={1} fill={'#fff'} fillOpacity={1} fillRule={'evenodd'} stroke={'#000000'} strokeWidth={1.5}
				strokeLinecap={'round'} strokeLinejoin={'round'} strokeMiterlimit={4} strokeDasharray={'none'}
				strokeOpacity={1} transform="translate(0,0.3)">
				...
				<path d="M 11,14 L 34,14" fill={'none'} stroke={'#000'} strokeLinejoin={'miter'} />
			</g>,
		knight:
			<g opacity={1} fill={'none'} fillOpacity={1} fillRule={'evenodd'} stroke={'#000'} strokeWidth={1.5} strokeLinecap={'round'} strokeLinejoin={'round'} strokeMiterlimit={4} strokeDasharray={'none'} strokeOpacity={1} transform="translate(0,0.3)">
				<path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18" fill={'#fff'} stroke={'#000'} />
		...
		bishop:
			<g opacity={1} fill={'none'} fillRule={'evenodd'} fillOpacity={1} stroke={'#000'} strokeWidth={1.5} strokeLinecap={'round'} strokeLinejoin={'round'} strokeMiterlimit={'4'} strokeDasharray={'none'} strokeOpacity={1} transform="translate(0,0.6)">
				...
				<path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18"
						fill={'none'} stroke={'#000'} strokeLinejoin={'miter'}/>
			</g>,
		pawn: <path d="m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z"
					opacity={1} fill={'#fff'} fillOpacity={1} fillRule={'nonzero'} stroke={'#000'} strokeWidth={1.5} strokeLinecap={'round'} strokeLinejoin={'miter'} strokeMiterlimit={'4'} strokeDasharray={'none'} strokeOpacity={1}/>
	},
	black: {
		king:
			<g fill={'none'} fillOpacity={1} fillRule={'evenodd'} stroke={'#000'} strokeWidth={1.5} strokeLinecap={'round'} strokeLinejoin={'round'}
				strokeMiterlimit={4} strokeDasharray={'none'} strokeOpacity={1}>
				<path d="M 22.5,11.63 L 22.5,6" fill={'none'} stroke={'#000'} strokeLinejoin={'miter'} id="path6570"/>
				<path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25"
						fill={'#000'} fillOpacity={1} strokeLinecap={'butt'} strokeLinejoin={'miter'}/>
				<path d="M 12.5,37 C 18,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 12.5,37"
						fill={'#000'} stroke={'#000'}/>
				<path d="M 20,8 L 25,8" fill={'none'} stroke={'#000'} strokeLinejoin={'miter'}/>
		...
		queen:
			<g fill={'#000'} stroke={'#000'} strokeWidth={1.5} strokeLinecap={'round'} strokeLinejoin={'round'}>
				...
				<circle cx="31" cy="9" r="2" />
				<circle cx="39" cy="12" r="2" />
				<path d="M 11,38.5 A 35,35 1 0 0 34,38.5" fill={'none'} stroke={'#000'} strokeLinecap={'butt'} />
		...
		rook:
			<g opacity={1} fill={'#000'} fillOpacity={1} fillRule={'evenodd'} stroke={'#000'} strokeWidth={1.5}
				strokeLinecap={'round'} strokeLinejoin={'round'} strokeMiterlimit={4} strokeDasharray={'none'}
				strokeOpacity={1} transform="translate(0,0.3)">
				<path d="M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z " strokeLinecap={'butt'} />
				...
				<path d="M 12,35.5 L 33,35.5 L 33,35.5" fill={'none'} stroke={'#fff'} strokeWidth={1} strokeLinejoin={'miter'} />
				<path d="M 13,31.5 L 32,31.5" fill={'none'} stroke={'#fff'} strokeWidth={1} strokeLinejoin={'miter'} />
				<path d="M 14,29.5 L 31,29.5" fill={'none'} stroke={'#fff'} strokeWidth={1} strokeLinejoin={'miter'} />
				<path d="M 14,16.5 L 31,16.5" fill={'none'} stroke={'#fff'} strokeWidth={1} strokeLinejoin={'miter'} />
				<path d="M 11,14 L 34,14" fill={'none'} stroke={'#fff'} strokeWidth={1} strokeLinejoin={'miter'} />
			</g>,
		knight:
			<g opacity={1} fill={'none'} fillOpacity={1} fillRule={'evenodd'} stroke={'#000'} strokeWidth={1.5}
				strokeLinecap={'round'} strokeLinejoin={'round'} strokeMiterlimit={4} strokeDasharray={'none'}
				strokeOpacity={1} transform="translate(0,0.3)">
				...
				<path d="M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z"
					transform="matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)" fill={'#fff'} stroke={'#fff'} />
		...
		bishop:
			<g opacity={1} fill={'none'} fillRule={'evenodd'} fillOpacity={1} stroke={'#000'} strokeWidth={1.5}
				strokeLinecap={'round'} strokeLinejoin={'round'} strokeMiterlimit={4} strokeDasharray={'none'} strokeOpacity={1} transform="translate(0,0.6)">
				...
				<path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18"
						fill={'none'} stroke={'#fff'} strokeLinejoin={'miter'}/>
			</g>,
		pawn:   <path d="m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z"
						  opacity={1} fill={'#000'} fillOpacity={1} fillRule={'nonzero'} stroke={'#000'} strokeWidth={1.5}
